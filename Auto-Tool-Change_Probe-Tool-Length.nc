...
%TOOLCHANGE_MAGAZINE = 0
%TOOLCHANGE_PULLOFF = -40
%TOOLCHANGE_RETRACT = -10
...
G53 G1 Z[TOOLHOLDER_Z] F[TOOLCHANGE_RETRACT_FEEDRATE]
G53 G1 Y[TOOLCHANGE_MAGAZINE] F[TOOLCHANGE_FEEDRATE]
%wait
M8
G53 G1 Z[TOOLCHANGE_PULLOFF] F[TOOLCHANGE_FEEDRATE]
M9
G53 G1 Z[TOOLCHANGE_RETRACT]  F[TOOLCHANGE_RETRACT_FEEDRATE]
G53 G0 X[TOOLHOLDER_CURRENT_X]
G53 G1 Z[TOOLCHANGE_PULLOFF] F[TOOLCHANGE_RETRACT_FEEDRATE]
M8
G53 G1 Z[TOOLHOLDER_Z] F[TOOLCHANGE_FEEDRATE]
M9
%wait
...
G49
G53 G0 Z[MACHINE_MAX_Z]
G53 G0 X[TOOL_PROBE_X]Y[TOOL_PROBE_Y]
